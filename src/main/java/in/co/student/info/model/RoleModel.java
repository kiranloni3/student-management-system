...
import in.co.student.info.bean.RoleBean;
...
public class RoleModel 
{
    ...
    public Integer nextPK() throws DatabaseException {
        ...
        try {
            ...
            PreparedStatement pstmt = conn
                    .prepareStatement("SELECT MAX(ID) FROM S_ROLE");
    ...
    public long add(RoleBean bean) throws ApplicationException,
        ...
        try {
            ...
            PreparedStatement pstmt = conn
                    .prepareStatement("INSERT INTO S_ROLE VALUES(?,?,?,?,?,?,?)");
            pstmt.setInt(1, pk);
     ...
     */
	    public void delete(RoleBean bean) throws ApplicationException {
	        ...
	        try {
	            ...
	            conn.setAutoCommit(false); // Begin transaction
	            PreparedStatement pstmt = conn
	                    .prepareStatement("DELETE FROM S_ROLE WHERE ID=?");
    ...
    public RoleBean findByPK(long pk) throws ApplicationException {
        ...
        StringBuffer sql = new StringBuffer("SELECT * FROM S_ROLE WHERE ID=?");
        RoleBean bean = null;
        Connection conn = null;
        try {
            conn = JDBCDataSource.getConnection();
    ...
    public void update(RoleBean bean) throws ApplicationException,
        ...
        try {
            ...
            conn.setAutoCommit(false); // Begin transaction
            PreparedStatement pstmt = conn
                    .prepareStatement("UPDATE S_ROLE SET NAME=?,DESCRIPTION=?,CREATED_BY=?,MODIFIED_BY=?,CREATED_DATETIME=?,MODIFIED_DATETIME=? WHERE ID=?");
    ...
    public List search(RoleBean bean, int pageNo, int pageSize)
        ...
        StringBuffer sql = new StringBuffer("SELECT * FROM S_ROLE WHERE 1=1");
        if (bean != null) {
            if (bean.getId() > 0) {
    ...
    public List list(int pageNo, int pageSize) throws ApplicationException {
        ...
        ArrayList list = new ArrayList();
        StringBuffer sql = new StringBuffer("select * from S_ROLE");
        // if page size is greater than zero then apply pagination
        if (pageSize > 0) {
            // Calculate start record index
            pageNo = (pageNo - 1) * pageSize;
