...
<%@page import="in.co.student.info.controller.StudentListCtl"%>
...
<br><br>
<form action="<%=SIMView.STUDENT_LIST_CTL%>" method="post">
<div class="container">
	...
	<div class="row">
					...
					<div class="row">
							...
							<div class="col-sm-3 form-group">
								...
								<input type="submit"
                       			 name="operation" class="btn btn-md btn-info" value="<%=StudentListCtl.OP_SEARCH%>" >
							</div>
						</div>					
			</div>		
		</div>
